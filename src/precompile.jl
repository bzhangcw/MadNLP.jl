...
function HS15Model(T = Float64; x0=zeros(2), y0=zeros(2))
    return HS15Model(
...
# function jac_dense!(nlp::HS15Model, x::AbstractVector, J::AbstractMatrix)
#     J[1, 1] = x[2]    # (1, 1)
#     J[1, 2] = x[1]    # (1, 2)
#     J[2, 1] = 1.0     # (2, 1)
#     J[2, 2] = 2*x[2]  # (2, 2)
...
# function hess_dense!(nlp::HS15Model, x, y, H::AbstractMatrix; obj_weight=1.0)
